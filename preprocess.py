...
'''
dd = torch.load('training_t10mc6.pt')
...
training = (tata[:10000], label[:10000])
test = (tata[10000:], label[10000:])

torch.save(training, 'training_t02mc6.pt')
torch.save(test, 'test_t02mc6.pt')
